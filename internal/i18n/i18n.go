...
var catalogZH = map[string]string{
	...
	"api.shortFiction.revisionConflict":       "预览后目标文件已变化，请检查当前文件并重新生成。",
...
var catalogEN = map[string]string{
	...
	"api.shortFiction.revisionConflict":       "The target changed after preview. Review the current file and generate again.",
